...
public class HoraAdapter extends RecyclerView.Adapter<HoraAdapter.MyViewHolder>{
    ...
    public Especialista especialista = Singleton.getInstacia().getEspecialista();

    public DiasDaSemana diasDaSemana = Singleton.getInstacia().getDiasDaSemana();
        ...
        myRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot postSnapshot : dataSnapshot.getChildren()) {
                    ...
                    if(especialista.getIdEspecialista().equals(consulta.getIdEspecialista())){
                        if(diasDaSemana.getDataDeHoje().equals(consulta.getDataConsulta())){
